...
const ButtonPage: React.FC = () => {
    ...
    return(
      <section>
        <button
        className='h-16 shadow-2xl drop-shadow-2xl duration-300 flex items-center rounded-3xl p-3 bg-gradient-to-br from-azul-700 via-azul-600 to-azul-500 gap-3 
