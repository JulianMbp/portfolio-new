...
export default function Experiencia(){
    return(
        <section className="w-full min-h-screen font-mono grid grid-cols-1 lg:grid-cols-[0.4fr_1fr] justify-center overflow-hidden px-2 sm:px-4 md:px-6 lg:px-8">
            <div className="order-1 p-1 sm:p-2 md:p-3 lg:p-4">
                <Presentacion/>
            </div>
