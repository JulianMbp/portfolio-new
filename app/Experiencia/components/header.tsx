...
export default function Header() {
    ...
    <div className="my-5 justify-around flex px-32">
        ...
        <button className="h-16 order-2 shadow-2xl drop-shadow-2xl duration-300 flex items-center rounded-3xl p-3 bg-gradient-to-t from-azul-700 via-azul-800 to-azul-900 gap-2 
